...
xcopy "D:\Projects\Current\WoW\ace3\AceConfig-3.0" ".\libs\AceConfig-3.0"  /Y /S /I
...
xcopy "D:\Projects\Current\WoW\libkeybound-1-0\LibKeyBound-1.0" ".\libs\LibKeyBound-1.0" /Y /S /I
