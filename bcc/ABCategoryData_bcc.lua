...
function AB.InitializeCategories()
	...
	AutoBarCategoryList["Spell.Mage.Create Manastone"] = SpellsCategory:new( "Spell.Mage.Create Manastone", spellIconList["Conjure Mana Jade"],
	{
		...
		"MAGE", AB.GetSpellNameByName("Conjure Mana Emerald"),
	})
...
--			"MAGE", AB.GetSpellNameByName("Conjure Refreshment"),
	...
	AutoBarCategoryList["Spell.Class.Buff"] = SpellsCategory:new( "Spell.Class.Buff", spellIconList["Barkskin"], nil,
	{
		...
		"PALADIN", AB.GetSpellNameByName("Blessing of Might"), AB.GetSpellNameByName("Blessing of Might"),
		"PALADIN", AB.GetSpellNameByName("Blessing of Protection"), AB.GetSpellNameByName("Blessing of Protection"),
		"PALADIN", AB.GetSpellNameByName("Blessing of Sacrifice"), AB.GetSpellNameByName("Blessing of Sacrifice"),
		"PALADIN", AB.GetSpellNameByName("Blessing of Salvation"), AB.GetSpellNameByName("Blessing of Salvation"),
		"PALADIN", AB.GetSpellNameByName("Greater Blessing of Kings"), AB.GetSpellNameByName("Greater Blessing of Kings"),
		...
		"PRIEST", AB.GetSpellNameByName("Feedback"), AB.GetSpellNameByName("Feedback"),
		"PRIEST", AB.GetSpellNameByName("Elune's Grace"), AB.GetSpellNameByName("Elune's Grace"),
		"PRIEST", AB.GetSpellNameByName("Shadowguard"), AB.GetSpellNameByName("Shadowguard"),
		"PRIEST", AB.GetSpellNameByName("Touch of Weakness"), AB.GetSpellNameByName("Touch of Weakness"),
		...
		"WARRIOR", AB.GetSpellNameByName("Battle Shout"), AB.GetSpellNameByName("Battle Shout"),
	})
	...
	AutoBarCategoryList["Spell.Seal"] = SpellsCategory:new( "Spell.Seal", spellIconList["Seal of the Crusader"], {
		...
		"PALADIN", AB.GetSpellNameByName("Seal of the Martyr"),
