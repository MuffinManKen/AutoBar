...
code.cache_spell_data(20484, "Rebirth");
...
code.cache_spell_data(19263, "Deterrence");
code.cache_spell_data(34477, "Misdirection");


code.cache_spell_data(5116, "Concussive Shot");
code.cache_spell_data(2974, "Wing Clip");

code.cache_spell_data(20736, "Distracting Shot");
code.cache_spell_data(19801, "Tranquilizing Shot");
code.cache_spell_data(19386, "Wyvern Sting");
code.cache_spell_data(19503, "Scatter Shot");
...
code.cache_spell_data(543, "Fire Ward");
code.cache_spell_data(1463, "Mana Shield");
...
code.cache_spell_data(30449, "Spellsteal");
...
code.cache_spell_data(27101, "Conjure Mana Emerald");
...
code.cache_spell_data(31884, "Avenging Wrath");
...
code.cache_spell_data(348704, "Seal of Corruption");
--#endregion
...
code.cache_spell_data(724, "Lightwell");
code.cache_spell_data(32375, "Mass Dispell");
code.cache_spell_data(453, "Mind Soothe");
code.cache_spell_data(33206, "Pain Suppression");
code.cache_spell_data(10060, "Power Infusion");
...
code.cache_spell_data(9035, "Hex of Weakness");
...
code.cache_spell_data(8050, "Flame Shock");
...
code.cache_spell_data(2825, "Bloodlust");
code.cache_spell_data(32182, "Heroism");
...
code.cache_spell_data(6366, "Create Firestone (Lesser)");
code.cache_spell_data(17951, "Create Firestone");
code.cache_spell_data(17952, "Create Firestone (Greater)");
code.cache_spell_data(17953, "Create Firestone (Major)");
code.cache_spell_data(27250, "Create Firestone (Master)");

code.cache_spell_data(2362, "Create Spellstone");
code.cache_spell_data(17727, "Create Spellstone (Greater)");
code.cache_spell_data(17728, "Create Spellstone (Major)");
code.cache_spell_data(28172, "Create Spellstone (Master)");
...
code.cache_spell_data(29858, "Soulshatter");
code.cache_spell_data(18788, "Demonic Sacrifice");
code.cache_spell_data(19028, "Soul Link");
...
--Warlock Pet
code.cache_spell_data(7812, "Sacrifice (Voidwalker)");
code.cache_spell_data(19505, "Devour Magic");
code.cache_spell_data(30153, "Intercept (Felguard)");
...
code.cache_spell_data(23920, "Spell Reflect");
